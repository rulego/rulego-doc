...
const DOMAIN_NAME = 'rulego.ayuntool.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "RuleGo",
      description: '基于Go语言的轻量级、高性能、嵌入式、编排式的规则引擎。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'rulego/rulego', // 导航栏右侧生成Github链接
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:ruelgo@outlook.com',
        },
        {
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'rulego,规则引擎,golang,go语言,编排式,规则链,热部署,数据集成,IoT,物联网平台,组件化,流程自动化,自动化引擎,应用集成,事件框架',
      },
    ],

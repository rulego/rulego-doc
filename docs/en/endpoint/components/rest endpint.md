---
title: Rest Endpoint
permalink: /pages/endpoint-rest/
---
***Rest Endpoint*** is used to create and start HTTP receiving service, it can register different [routes](/en/pages/endpoint-router/) to handle different requests.

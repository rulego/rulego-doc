...
- [Analytical Functions](/en/pages/streamsql-analytical-functions/) - Built-in analytic functions and the OVER clause
- [Aggregate Functions](/en/pages/streamsql-aggregate-functions/) - Built-in aggregate functions

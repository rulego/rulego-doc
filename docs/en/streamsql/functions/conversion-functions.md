...
**Description**: Converts a datetime to Unix seconds (`int64`). The argument may be a `time.Time`, date string, or numeric (numeric treated as Unix seconds); equivalent to `unix_timestamp`.

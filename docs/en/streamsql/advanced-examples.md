...
This page collects advanced usage such as custom functions and performance modes. For basic onboarding, see [Quick Start](/en/pages/streamsql-quickstart/).
...
- [Quick Start](/en/pages/streamsql-quickstart/)

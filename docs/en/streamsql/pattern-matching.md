...
- **Comparing adjacent events** ("did it change vs last time", "what was the previous value") → [analytic functions](/en/pages/streamsql-analytical-functions/) (`lag`/`had_changed`).
...
Full business-scenario cases are in [Device Fault Pattern Recognition](/en/pages/streamsql-case-cep/), covering:

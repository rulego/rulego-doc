...
2. [Config.OnEndWithFailure=true](/en/pages/d59341/#onendwithfailure) , which can avoid the problem that the rule chain cannot end because the exception or Failure branch is not connected to the End node.
:::

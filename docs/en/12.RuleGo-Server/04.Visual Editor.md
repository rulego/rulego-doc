...
> For an illustrated guide, see [Debugging Rule Chains](/pages/rulego-server-debug/).

## AI Features

The editor integrates an AI assistant panel (conversational creation/modification of rule chains), one-click AI generation, and AI Agent chat functionality. For details, see [AI Features](/pages/rulego-server-ai/#using-ai-in-the-editor) and [AI Assistant Tutorial](/pages/rulego-server-ai-tutorial/).

...
Use the built-in [LimierAspect](/en/pages/limiter-aspect/) to limit the concurrent execution of rule chains. Example code:
```go
...
For details, refer to: [About rule engine execution interruption recovery](/en/pages/interrupt-recovery/)
...
We provide RuleGo-Editor as a tool for rule chain visualization. For details, refer to: [RuleGo-Editor](/en/pages/rulego-server-editor/)

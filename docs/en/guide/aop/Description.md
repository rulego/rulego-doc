...
- **Aspect:** is the collection of pointcuts and advice. For example: [Debug Aspect](/en/pages/debug-aspect/) It implements Before Advice and After Advice.
  - The framework has some built-in aspects, such as: [Debug Aspect](/en/pages/debug-aspect/), [Fallback Aspect](/en/pages/fallback-aspect/).

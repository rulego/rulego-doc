---
title: Other
permalink: /pages/interrupt-recovery/
---
...
2. Register the rule engine execution end callback function to persist msg and related state (if necessary): [WithOnEnd](/en/pages/options/#RuleContextOption).
```go

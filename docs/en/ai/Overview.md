...
> For a complete L4 agent platform case study, see [Application Case Study](/en/pages/ai-agent-case-study/).
...
- [Development Guide](/en/pages/ai-agent-guide/) — Complete workflow for building agent applications
- [Orchestration Examples](/en/pages/ai-agent-orchestration/) — Practical examples of combining agents with rule chain nodes
- [Application Case Study](/en/pages/ai-agent-case-study/) — Complete production case of a smart assistant platform

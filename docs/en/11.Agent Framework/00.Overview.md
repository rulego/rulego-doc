...
>
> A stdlib-only lightweight implementation of `ai/agent` (usable on 32-bit platforms) shares the same type name and chain DSL; the string `tools` shorthand is the portable form across both — see [Tool System · String Shorthand](03.Tool%20System.md#string-shorthand).

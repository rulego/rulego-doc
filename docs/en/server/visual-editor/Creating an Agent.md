...
> The `ai/agent` node is the core of the agent, responsible for the LLM reasoning and tool call loop. For the complete component configuration reference, see [Agent Component](/pages/ai-agent/).
...
- [Agent Component](/pages/ai-agent/) — Complete configuration reference for the `ai/agent` node

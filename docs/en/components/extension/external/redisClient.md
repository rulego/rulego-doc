...
| params                                 | array  | Command parameters, supports ${} variable replacement and [Component Configuration Variables](/en/pages/component-configuration-variables/) | None          |
...
- **Component configuration variables**: Supports all [Component Configuration Variables](/en/pages/component-configuration-variables/) syntax

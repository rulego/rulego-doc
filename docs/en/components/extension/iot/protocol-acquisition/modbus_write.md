...
---
`x/modbusWrite` component: <Badge text="v0.37.0+"/> batch-writes Modbus points over TCP/RTU, using industry-standard **Modicon traditional addresses**. Routes to `Success`/`Failure`.

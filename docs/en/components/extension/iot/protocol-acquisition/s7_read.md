...
---
`x/s7Read` component: <Badge text="v0.37.0+"/> Batch reads point data from Siemens S7 series PLCs (S7-200SMART/300/400/1200/1500). Results are written back to `msg.Data` and forwarded via the `Success` chain.

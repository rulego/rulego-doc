...
|---------------|--------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|
| repository    | string | Git repository URL, can use [component configuration variables](/en/pages/component-configuration-variables/)                                                                                                                  | Obtained from metadata's ref     |
| directory     | string | Local directory to clone into, can use [component configuration variables](/en/pages/component-configuration-variables/)                                                                                                       | Obtained from metadata's workDir |
| refSpecs      | string | Defines the mapping between local and remote branches, e.g., refs/heads/main:refs/heads/main. Multiple mappings separated by commas, can use [component configuration variables](/en/pages/component-configuration-variables/) | refs/heads/main                  |

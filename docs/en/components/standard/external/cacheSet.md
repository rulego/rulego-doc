...
|-------|-------------|-------------------------------------------------------------------------------------|---------------|
| items | []CacheItem | List of cache items, can use [component configuration variables](/en/pages/component-configuration-variables/) | None          |
...
| key   | string | Key, can use [component configuration variables](/en/pages/component-configuration-variables/)                                                                           | None          |
| value | any    | Value, can use [component configuration variables](/en/pages/component-configuration-variables/)                                                                         | None          |

...
|-----------------------------------------------|--------|-------------------------------------------------------------------------------------|------------------------------------|
| restEndpointUrlPattern                        | string | HTTP URL address, can using [Component Configuration Variables](/en/pages/component-configuration-variables/). | None                               |
| requestMethod                                 | string | Request method                                                                      | POST                               |
| body                                          | string | Request body supports [component configuration variables](/en/pages/component-configuration-variables/) .      | Message payload                    |
| withoutRequestBody                            | bool   | without request body                                                                | false                              |
| headers                                       | map    | Request header, can using [Component Configuration Variables](/en/pages/component-configuration-variables/).   | "Content-Type": "application/json" |

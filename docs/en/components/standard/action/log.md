...
> JavaScript scripts support ECMAScript 5.1(+) syntax specifications and some ES6 specifications, such as: async/await/Promise/let. Custom Go functions can be called within scripts, please refer to [udf](/pages/config/#udf).

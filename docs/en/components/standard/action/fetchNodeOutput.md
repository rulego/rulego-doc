...
- Besides using the `fetchNodeOutput` component, you can also retrieve other nodes' outputs through [Component Configuration Variables](/en/pages/component-configuration-variables/) syntax, such as: `${node1.msg.temperature}`, `${sensor2.metadata.deviceId}`, etc.

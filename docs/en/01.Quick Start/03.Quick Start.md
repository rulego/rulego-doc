...
## Others
1. We have built in a large number of [standard components](/en/pages/standard-components/) and [extended components](/en/pages/d7fc43/) . You only need to combine these components in a configuration - based way to meet your functional requirements.

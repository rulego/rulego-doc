...
|---------------|--------|-------------------------------------------------------------------------------------------------------|---------------------------------------|
| repository    | string | Git repository URL, can use [component configuration variables](/pages/component-configuration-variables/)                       | Obtained from the ref in metadata     |
| directory     | string | Local directory to clone into, can use [component configuration variables](/pages/component-configuration-variables/)            | Obtained from the workDir in metadata |
| reference     | string | Full reference name of the branch or tag, can use [component configuration variables](/pages/component-configuration-variables/) | refs/heads/main                       |

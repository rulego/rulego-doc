...
`x/modbusRead` component: <Badge text="v0.35.0+"/> batch-reads Modbus points over TCP/RTU. Results are written back to `msg.Data` as a list of the **unified contract** `iot_points.Data`, routing to `Success`/`Failure`.

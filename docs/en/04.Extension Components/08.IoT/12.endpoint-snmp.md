...
- **Complementary to active collection**: use this endpoint for alarm events; for periodic metric collection use [`x/snmpRead`](/pages/x-snmp-read/) triggered by an `endpoint/schedule` endpoint.

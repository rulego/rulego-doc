...
Acquisition output is a **point array** (one name/value per point), while TSDB write needs a **map form** (measurement + fields). Use `x/iotToSeries` or a script node to pivot:

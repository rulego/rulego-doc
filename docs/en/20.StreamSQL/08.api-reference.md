...
On top of printf-style logging, StreamSQL provides a **structured logging** layer (key-value) that supports both logfmt text and JSON output formats. See [Structured Logging](/en/pages/streamsql-structured-logging/).
:::

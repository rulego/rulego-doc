...
- [IoT Temperature Alerting and Metrics Aggregation](/en/pages/streamsql-case-iot-temperature/) - Per-reading alerting, event-time windowed aggregation, CountingWindow State TTL, TriggerWindow testing

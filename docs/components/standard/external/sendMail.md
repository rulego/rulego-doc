...
| subject | string | 邮件主题，支持使用[组件配置变量](/pages/component-configuration-variables/)进行变量替换          | 无   |
| body    | string | 邮件正文内容，支持HTML格式，可使用[组件配置变量](/pages/component-configuration-variables/)进行变量替换 | 无   |

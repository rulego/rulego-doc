...
curl -X POST http://localhost:9090/api/v1/rules/iot-router \
  -H "Content-Type: application/json" \
  -H "X-API-Key: ak-2af255ea5618467d914c67a8beeca31d" \
  -d '{
  "ruleChain": {
    "id": "iot-router",
    "name": "温度过滤推送",
...
```bash
# 通过 X-API-Key 请求头
curl -H "X-API-Key: ak-2af255ea5618467d914c67a8beeca31d" ...

# 或通过 Authorization 请求头
curl -H "Authorization: Bearer ak-2af255ea5618467d914c67a8beeca31d" ...
```
...
API_KEY="ak-2af255ea5618467d914c67a8beeca31d"

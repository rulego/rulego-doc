...
- 编辑器：[http://8.134.32.225:9090/editor/](http://8.134.32.225:9090/editor/)
- UI 界面：[http://8.134.32.225:9090/ui/](http://8.134.32.225:9090/ui/)

编辑器详细文档：[https://editor.rulego.cc/](https://editor.rulego.cc/)
...
> 图文操作指南请参见 [调试规则链](/pages/rulego-server-debug/)。

## AI 功能

编辑器集成了 AI 助手面板（对话式创建/修改规则链）、AI 一键生成和 AI Agent 对话功能，详见 [AI 功能](/pages/rulego-server-ai/#在编辑器中使用ai) 和 [AI 助手使用教程](/pages/rulego-server-ai-tutorial/)。
...
> 完整集成指南（能力开关、token 注入、主题样式、导出清单）见 [rulego-editor/docs/guide.md](https://github.com/rulego/rulego-editor/blob/main/docs/guide.md)。

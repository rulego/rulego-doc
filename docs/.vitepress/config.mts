...
const zhNav = [
  { text: '首页', link: '/' },
  { text: '指南', link: '/pages/introduction/' },
  { text: '组件', link: '/pages/standard-components/' },
  { text: 'Endpoint', link: '/pages/endpoint-overview/' },
  { text: 'StreamSQL', link: '/pages/streamsql-overview/' },
  { text: '智能体', link: '/pages/ai-agent-overview/' },
  { text: 'Server', link: '/pages/rulego-server/' },
...
const enNav = [
  { text: 'Home', link: '/en/' },
  { text: 'Guide', link: '/en/pages/introduction/' },
  { text: 'Components', link: '/en/pages/standard-components/' },
  { text: 'Endpoint', link: '/en/pages/endpoint-overview/' },
  { text: 'StreamSQL', link: '/en/pages/streamsql-overview/' },
  { text: 'Agent', link: '/en/pages/ai-agent-overview/' },
  { text: 'Server', link: '/en/pages/rulego-server/' },
